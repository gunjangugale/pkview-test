...
@xcopy "%~dp0\iPortal\Publish" %folderPath%\iPortal_Publish /E /K /I /Y
@xcopy "%~dp0\SasJobs.Api\Publish" %folderPath%\SasJobs_Publish /E /K /I /Y

@cd %~dp0
@call iPortalDeploy.bat %folderPath%
@call SasJobsDeploy.bat %folderPath%

@xcopy "%~dp0\SasJobs.BackgroundWorker.Host\bin\Debug"  "%folderPath%\Sasjobs.Standalone" /E /K /I /Y
