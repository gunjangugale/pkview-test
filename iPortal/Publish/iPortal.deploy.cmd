...
set _DeploySetParametersFile=%RootPath%iPortal.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%iPortal.zip" (
echo "%RootPath%iPortal.zip" does not exist. 
...
:usage
echo =========================================================
if not exist "%RootPath%iPortal.deploy-readme.txt" (
...
start notepad "%RootPath%iPortal.deploy-readme.txt"
)
echo =========================================================
goto :eof
